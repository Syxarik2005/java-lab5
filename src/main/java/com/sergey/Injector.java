...
public class Injector {
    ...
    /**
     * Создает инжектор и загружает конфигурацию из указанного файла в ресурсах
     *
     * @param configPath Путь к файлу .properties относительно папки resources
     ...
     * @throws RuntimeException если не удается найти класс реализации, создать экземпляр или получить доступ к полю
     */
